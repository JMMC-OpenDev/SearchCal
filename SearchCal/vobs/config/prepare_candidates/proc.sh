...
then
    # filter SIMBAD main_type (stars only) ?
    # subset: other_types.contains("*") to exclude Planet, Galaxy ...
    stilts ${STILTS_JAVA_OPTIONS} tpipe in=$CAT_SIMBAD cmd='progress; select other_types.contains(\"*\") ' out=$CAT_SIMBAD_OBJ
...
then
    stilts ${STILTS_JAVA_OPTIONS} tmatch2 matcher='sky' params='3.0' values1='_RAJ2000 _DEJ2000' values2='ra dec' find='best1' fixcols='all' join='all1' in1=$CAT_ASCC_MIN_GRP in2=$CAT_SIMBAD_MIN out=$CAT_ASCC_SIMBAD_GRP
    stilts ${STILTS_JAVA_OPTIONS} tpipe in=$CAT_ASCC_SIMBAD_GRP cmd='progress ; delcols "main_id_2 GroupID Separation" ; colmeta -name SIMBAD_GROUP_SIZE GroupSize ' out=$CAT_ASCC_SIMBAD_GRP
...
# | ASCC_GROUP_SIZE_1 | 2.0271235  | 0.1670802  | 2           | 4         | 31412   |
# | ra_2              | 188.44556  | 100.37907  | 3.347126E-4 | 359.9999  | 2471828 |
# | dec_2             | -3.4264386 | 41.397297  | -89.88967   | 89.83233  | 2471828 |
...
then
    ...
    stilts ${STILTS_JAVA_OPTIONS} tmatch2 matcher='sky' params='1.0' values1='_RAJ2000_1 _DEJ2000_1' values2='ra dec' find='best1' fixcols='all' join='all1' in1=$CAT_ASCC_SIMBAD_GRP in2=$CAT_SIMBAD_SUB out=$CAT_ASCC_SIMBAD_XMATCH 
    stilts ${STILTS_JAVA_OPTIONS} tpipe in=$CAT_ASCC_SIMBAD_XMATCH cmd='progress ; delcols "ra_2_1 dec_2_1 GroupSize GroupID" ; colmeta -name XM_SIMBAD_sep Separation ' out=$CAT_ASCC_SIMBAD_XMATCH
...
# | ASCC_GROUP_SIZE_1_1 | 2.0271235  | 0.1670802  | 2           | 4          | 31412   |
# | SIMBAD_GROUP_SIZE_1 | 2.0057063  | 0.07532475 | 2           | 3          | 11566   |
# | ra_2a               | 188.47241  | 100.38047  | 3.347126E-4 | 359.9999   | 2461739 |
# | dec_2a              | -3.4374816 | 41.39973   | -89.88967   | 89.83233   | 2461739 |
# | main_id_2           |            |            |             |            | 2461739 |
# | sp_type_2           |            |            |             |            | 500163  |
# | main_type_2         |            |            |             |            | 2461739 |
# | other_types_2       |            |            |             |            | 2461739 |
# | XM_SIMBAD_sep       | 0.11238486 | 0.10825914 | 0.0         | 0.99995977 | 2461739 |
# +---------------------+------------+------------+-------------+------------+---------+
fi
...
then
    ...
    stilts ${STILTS_JAVA_OPTIONS} tpipe in=$CAT_ASCC_SIMBAD_XMATCH cmd='progress ; addcol -after sp_type_2 -ucd OBJ_TYPES OTYPES NULL_main_type_2?\"\":replaceAll(concat(\",\",main_type_2,\",\",replaceAll(other_types_2,\"[|]\",\",\"),\",\"),\"\ \",\"\") ; delcols "ra_2a dec_2a main_type_2 other_types_2" ; addcol -before _RAJ2000_1_1 -ucd POS_EQ_RA_MAIN RAJ2000 degreesToHms(_RAJ2000_1_1,5) ; addcol -after RAJ2000 -ucd POS_EQ_DEC_MAIN DEJ2000 degreesToDms(_DEJ2000_1_1,5) ; addcol -after DEJ2000 -ucd POS_EQ_PMRA pmRA pmRA_1_1 ; addcol -after pmRA -ucd POS_EQ_PMDEC pmDE pmDE_1_1 ; addcol -after pmDE -ucd ID_MAIN MAIN_ID main_id_2 ; colmeta -name SP_TYPE -ucd SPECT_TYPE_MK sp_type_2 ; addcol -ucd GROUP_SIZE GROUP_SIZE_3 max((!NULL_ASCC_GROUP_SIZE_1_1?ASCC_GROUP_SIZE_1_1:0),(!NULL_SIMBAD_GROUP_SIZE_1?SIMBAD_GROUP_SIZE_1:0)) ; sort _DEJ2000_1_1 ; delcols "_RAJ2000_1_1 _DEJ2000_1_1 ASCC_GROUP_SIZE_1_1 SIMBAD_GROUP_SIZE_1 pmRA_1_1 pmDE_1_1 main_id_2" ' out=$FULL_CANDIDATES
...
# GROUP_SIZE_3	$9	Integer		Number of rows in match group	GROUP_SIZE		int		-2147483648
