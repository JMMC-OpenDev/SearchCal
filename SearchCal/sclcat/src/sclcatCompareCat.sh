...
do 
    ...
    then
        echo $m
        stilts ${STILTS_JAVA_OPTIONS} plothist xpix=900 ypix=650 out="$PNG" ylog=true norm=false xdata1="$m" xdata2="$m" xdata3="$m" xdata4="$m" ofmt=png in1=$CAT1 in2=$CAT2 in3=1not2.fits in4=2not1.fits name1=CAT1 name2=CAT2 name3=1not2 name4=2not1
...
do 
    ...
    then
        echo $m
        stilts ${STILTS_JAVA_OPTIONS} plothist xpix=900 ypix=650 out="$PNG" xlog=true ylog=true norm=false xdata1="$m" xdata2="$m" xdata3="$m" xdata4="$m" ofmt=png in1=$CAT1 in2=$CAT2 in3=1not2.fits in4=2not1.fits name1=CAT1 name2=CAT2 name3=1not2 name4=2not1
        toHtml "<image src='$PNG' alt='meta $m'/>"
    fi
done
...
doHR(){
    ...
    then 
        ...
        then
            ...
            stilts ${STILTS_JAVA_OPTIONS} plot2d xpix=900 ypix=650 out="old_$PNG" size1="0" size2="0" xdata1="$x" xdata2="$x" ydata1="$y" ydata2="$y" ofmt=png in1=$CAT1 in2=1not2.fits name1=CAT1 name2=1not2 
            stilts ${STILTS_JAVA_OPTIONS} plot2d xpix=900 ypix=650 out="new_$PNG" size1="0" size2="0" xdata1="$x" xdata2="$x" ydata1="$y" ydata2="$y" ofmt=png in1=$CAT2 in2=2not1.fits name1=CAT2 name2=2not1
            toHtml "<tr><td>"
...
do
    ...
    stilts ${STILTS_JAVA_OPTIONS} plot2d xpix=900 ypix=650 out="$PNG" xdata1="$x" xdata2="$x" xdata3="$x" xdata4="$x" ydata1="$y" ydata2="$y" ydata3="$y" ydata4="$y" ofmt=png in1=$CAT1 in2=$CAT2 in3=1not2.fits in4=2not1.fits name1=CAT1 name2=CAT2 name3=1not2 name4=2not1
        toHtml "<image src='$PNG' alt='meta $m'/>"
done
}
...
do 
    ...
    echo ${diff_col}
    stilts ${STILTS_JAVA_OPTIONS} plothist xpix=900 ypix=650 out="$PNG" ylog=true norm=false xdata1="${diff_col}" ofmt=png in1=1and2.fits name1=1and2
