...
; Histogram of residuals
  ...
  RES=GAUSSFIT(XX,HH,NTERMS=3,Z) & PLOT,XX,HH,PSYM=10 & OPLOT,XX,RES,COLOR=65000 & IF (DOPRINT) THEN PRINT,"Polynoms: Z=",UNITLOG,Z 
rep='' & if (dowait) then READ, 'press any key to continue', rep
;
...
; Plot histograms
  ...
  FOR N=0, NCOLORS-1 DO BEGIN
     ...
     PLOT,XX,HH,PSYM=10,XRANGE=[-5,5],XSTYLE=1 & OPLOT,XX,RES,COLOR=65000 & IF (DOPRINT) THEN PRINT,"Polynoms: Z=",Z
  ENDFOR
  HH=HISTOGRAM(RES_C[GOOD_B,*],BINSIZE=BIN,LOCATIONS=XX) & XX=XX+BIN/2. & RES=GAUSSFIT(XX,HH,NTERMS=3,Z)
  PLOT,XX,HH,PSYM=10,XRANGE=[-5,5],XSTYLE=1 & OPLOT,XX,RES,COLOR=1000 & IF (DOPRINT) THEN PRINT,"Polynoms: Z=",UNITLOG,Z
